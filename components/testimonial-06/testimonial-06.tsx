...
const testimonials = [
  {
    ...
    name: "James Harris",
    designation: "Founder",
    company: "Angel Recruiters & Co.",
    testimonial:
      "Thanks to Evallo, the quality of our applicants has doubled. We've reduced unqualified leads by half and our sales teams convert 1 in 3 calls. This is a huge improvement to the quality of our sales pipelines.",
    avatar: "",
  },
  {
    id: 2,
    ...
    testimonial:
      "Evallo is a lead engagement, lead qualification, lead automation and lead intelligence platform, all rolled into one - JUST WOW!",
    avatar: "",
  },
  {
    id: 3,
    ...
    company: "Greenhouse",
    testimonial:
      "We replaced 3 tools with Evallo. Our sales cycle shortened by 30%, and marketing finally knows what messaging works!",
    avatar: "",
  },
  {
    id: 4,
    ...
    testimonial:
      "Evallo replaced our first SDR call. Our data collection process has impressed our CXOs and our first sales calls are more personal - not wasting anyone's time.",
    avatar: "",
  },
];
const Testimonial06 = () => {
