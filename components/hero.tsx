...
export default function Hero({ 
  title = "Stop Building Logic Trees. Start Having Conversations.",
  description = "Typeform makes you play architect with complex branching logic. Evallo uses AI to conduct adaptive interviews that dig deeper, without the setup headache."
}: HeroProps) {
  return (
