...
export const metadata: Metadata = {
  title: "AI Survey Insights & Best Practices Blog | Evallo",
  description: "Expert insights on AI-powered surveys, conversational forms, customer research, and data collection strategies. Learn how to get better response rates and deeper insights.",
  keywords: [
    "AI survey blog",
    "survey best practices",
    "conversational survey tips",
    "customer research insights",
    "survey response rates",
    "AI chat survey guides"
  ],
  openGraph: {
    title: "AI Survey Insights & Best Practices Blog | Evallo",
    description: "Expert insights on AI-powered surveys and customer research strategies. Get better response rates and deeper insights.",
    url: "https://evallo.app/blog",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "AI Survey Insights & Best Practices Blog | Evallo",
    description: "Expert insights on AI-powered surveys and customer research strategies.",
  },
  alternates: {
    canonical: "https://evallo.app/blog",
  },
};
